...
import { CreateError, Image, ImageData } from '../../models/image.model';
...
export const createImageFailure = createAction('[Images] Create Failure', props<{ error: null | CreateError }>());
